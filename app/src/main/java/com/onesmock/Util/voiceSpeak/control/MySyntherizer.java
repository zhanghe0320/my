package com.onesmock.Util.voiceSpeak.control;
...
import com.onesmock.Util.voiceSpeak.MainHandlerConstant;
...
public class MySyntherizer implements MainHandlerConstant {
    ...
    protected boolean init(InitConfig config) {
        ...
        sendToUiThread(MainHandlerConstant.INIT_SUCCESS2, "合成引擎初始化成功");
        return true;
    }
